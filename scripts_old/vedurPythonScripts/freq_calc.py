...
guess=tcheck chkbas genchk geom=allcheck{3}
...
def process_command_line(argv):
    ...
    #Optional args
    parser.add_argument('-t', '--temper', help='temperature')
...
def main(argv):
    ...
    if args.temper:
        temper = ' Temperature=' + args.temper
    else:
        temper = ''
    for chk in args.input:
        name = get_filename(chk) + '_freq'
        formated_input = DEFAULT_INPUT.format(args.solvent, name, args.descrip, temper)
