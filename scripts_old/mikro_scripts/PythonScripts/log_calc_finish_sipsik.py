...
FIN_CALCS_LOG = '/home2/a92549/log/gaus_fin.log'
START_CALCS_LOG = '/home2/a92549/log/gaus_strt.log'
CALCS_SUMMRY_LOG = '/home2/a92549/log/gaus_calc_sumry.csv'
...
def NImag_check(log_str, right_number):
    ...
    NImag = gaussian.get_NImag(log_str)
    if NImag == right_number:
        return ''
    elif NImag == -1:
        return "No NImag were found."
    else:
