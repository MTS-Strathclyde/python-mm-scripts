...
updated Aug 8, 2012 (added function isBiggerThenCutoff)
...
def isBiggerThenCutoff(py_atoms, cutoff):
    """Checks, weather destance between any two atoms is closer then cutoff
    input is py_atoms list and cutoff distance in angstroms"""
...
class Molecule:
    ...
    def goalTest(self, angle_list, state_num):
        ...
        if self.high > d > self.low and isBiggerThenCutoff(atoms, 0.6):
