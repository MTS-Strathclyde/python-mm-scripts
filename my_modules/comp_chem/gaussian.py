...
class Input(object):
    ...
    def set_mult(self, mult):
        if mult < 5000: #frequent babel bug causes multiplicty to be BIG
            self.mult = str(mult)
        else:
            self.mult = '1'
...
#            print i
    ...
    def add_custom_basis_from_dic(self, json_basis_dic_path, ecp=True):
        ...
        if ecp:
            ...
            self.custom_basis = basis_string 
